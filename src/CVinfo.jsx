...
function CVinfos(){
    return <div className='infos'>
        ...
        <TextBox fontsize="52" marginXY='20px 0px' content="Abdelmoghit Merzouki Idrissi" fontweight="900"/>
        <TextBox fontsize="26" marginXY='10px 0px' content="Junior software developper ?" fontweight="700"/>
        <div style={{display:"flex"}}>
            <p style={{fontSize:"18px" , marginRight:"10px"}}> Email 📧 : </p>
            <TextBox fontsize="18" content="amidrissi2002@gmail.com" fontweight="400"/>
        </div>
        <div style={{display:"flex"}}>
            <p style={{fontSize:"18px" , marginRight:"10px"}} > phone📱: </p>
            <TextBox fontsize="18" marginXY='15px 0px 15px 0px' content="0789652145" fontweight="400"/>
        </div>
    </div>
